 ...
 */
package org.alfresco.extension.cadviewer.platformsample;
...
public class DemoComponentIT extends AbstractAlfrescoIT {
    ...
    public void testGetCompanyHome() {
        DemoComponent demoComponent = (DemoComponent) getApplicationContext().getBean("org.alfresco.extension.cadviewer.DemoComponent");
